...
const page = () => {
  const[title, settitle]= useState("") //title ek variable hai aur settitle ek function hai jiski help se ham title me value set karenge.
  ...
  renderTask=mainTask.map((t,i)=>{ //t=task name, i=index of that task
    return (
  ...
  return (
    ...
    <hr />
    <div className="p-8 bg-slate-200 text-5xl">
      <ul>
        {renderTask}
      </ul>
    </div>
